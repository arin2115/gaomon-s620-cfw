...
- **It is for the Gaomon S620 only** (tablet ID `OEM02_T18e_` and a date). Other Huion and Gaomon tablets look identical in DFU mode, so
  before writing anything the site reads the tablet's flash and refuses to flash if it is not an S620. Nothing is written then.
